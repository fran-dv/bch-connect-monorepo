...
export const Navbar: React.FC = () => {
	return (
		<header className="bg-transparent py-4 sm:py-5 px-3 sm:px-8 md:px-10 sticky top-0 flex justify-center ">
			<nav className="flex items-center gap-1 sm:gap-5 px-2 sm:px-8 sm:pr-4 py-2 bg-black-bch/75 z-10 w-full rounded-full max-w-300 shadow-xl backdrop-blur-xs">
